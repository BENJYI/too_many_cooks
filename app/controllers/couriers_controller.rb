class CouriersController < ApplicationController
  ...
  # GET /couriers
  def index
    @couriers = current_manager.couriers.all
  end
  ...
  # POST /couriers
  def create
    @courier = current_manager.couriers.build(courier_params)
    @courier.manager = current_manager
  ...
  private
    ...
    def courier_params
      params.require(:courier).permit(:email, :name, :address, :password, :password_confirmation)
    end
end